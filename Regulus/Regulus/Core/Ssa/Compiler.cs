...
namespace Regulus.Core.Ssa
{
    ...
    public class Compiler
    {
        ...
        private void AllocateRegister(Dictionary<Operand, List<Operand>> edges, List<List<Operand>> argumentGroups, int startRegIndex = 0)
        {
